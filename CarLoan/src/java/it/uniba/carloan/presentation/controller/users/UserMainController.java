...
public class UserMainController extends DefaultController implements Initializable {
    ...
    private ObservableList<User> loadedData = FXCollections.observableArrayList();
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        DataLoader<User> dataLoader = new DataLoader<User>() {
            ...
            protected Response dataLoadRequest() {
                return FrontController.handleRequest(GET_ALL, USER, null);
            }
    ...
    private void setSortedData() {
        ...
        FilteredList<User> filteredByName = new FilteredList<>(loadedData, user -> true);
