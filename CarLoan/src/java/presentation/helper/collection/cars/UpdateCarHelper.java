...
public class UpdateCarHelper implements Helper {
    private static final Logger log = Logger.getLogger(UpdateCarHelper.class.getName());
    ...
    public Response execute(TransferObject to) {
        ...
        try {
            ...
            response = manager.updateCar(car);
