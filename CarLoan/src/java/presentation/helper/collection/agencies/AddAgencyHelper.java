...
public class AddAgencyHelper implements Helper {
    private static final Logger log = Logger.getLogger(AddAgencyHelper.class.getName());
    ...
    public Response execute(TransferObject to) {
        ...
        try {
            ...
            response = agencyManager.addAgency(agency);
