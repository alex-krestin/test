...
public class ServiceMainController extends DefaultController implements Initializable{
    ...
    protected static Service currentService;
    ...
    public void deleteService() {
        if (currentService != null) {
            Boolean choice = AlertHandler.showAlertConfirmationDialog("Cancellazione servizio",
                    "Vuoi davvero cancellare servizio", "I dati non potranno essere ripristinati.",
                    "Cancella");

            if (choice) {
                TransferObject responce = FrontController.handleRequest(DELETE, SERVICE, currentService);
    ...
    public void getServicesList() {
        ...
        Task dataLoader = new Task<Boolean>() {
            ...
            protected Boolean call() throws Exception {
                ...
                TransferObject response = FrontController.handleRequest(GET_ALL, SERVICE, null);
                // extract list of objects <Agency> from TransferObject
                ArrayList<?> services = response.getArrayList();
