...
public class UserMainController extends DefaultController implements Initializable {
    ...
    protected static Agency currentAgency; // uses in addUser
    protected static User currentUser; // uses in editUser
    ...
    public void deleteCurrentUser() {
        //TODO ADD ALERTS
        if (currentUser != null) {
            FrontController.handleRequest(DELETE, USER, currentUser);
            // Update Users view
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        agency_code_column.setCellValueFactory(user -> new SimpleStringProperty(user.getValue().getAgency().getAgencyCode()));
    ...
    private void getAllUsers() {
        ...
        Task dataLoader = new Task<Boolean>() {
            ...
            protected Boolean call() throws Exception {
                ...
                TransferObject response = FrontController.handleRequest(GET_ALL, USER, null);
                // extract list of objects <User> from TransferObject
                ArrayList<?> users = response.getArrayList();
    ...
    private void setSortedData() {
        ...
        FilteredList<User> customFilter;
        ...
        agency_code_filter.textProperty().addListener((observable, oldValue, newValue) -> {
            filteredByAgencyCode.setPredicate(user -> {
                ...
                String lowerCaseFilter = newValue.toLowerCase();
                return user.getAgency().getAgencyCode().toLowerCase().contains(lowerCaseFilter);
            });
    ...
    private class RowSelectChangeListener implements ChangeListener<Number> {
        ...
        public void changed(ObservableValue<? extends Number> observable, Number oldValue, Number newValue) {
            ...
            city_label.setText(user.getAgency().getCity());
            address_label.setText(user.getAgency().getAddress());
            tel_label.setText(user.getAgency().getPhoneNumber());
            fax_label.setText(user.getAgency().getFaxNumber());
            email_label.setText(user.getAgency().getEmail());
        }
    }
    //endregion
