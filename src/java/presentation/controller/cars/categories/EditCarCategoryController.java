...
public class EditCarCategoryController extends AccessoryCategoryPopupController implements Initializable{
    ...
    public void handleEditServiceAction() {
        if (validateInput()) {
            ...
            if(!category.equals(currentCategory)) {
                TransferObject response = FrontController.handleRequest(UPDATE, CAR_CATEGORY, category);
