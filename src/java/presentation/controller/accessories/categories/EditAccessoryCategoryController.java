...
public class EditAccessoryCategoryController extends AccessoryCategoryPopupController implements Initializable{
    ...
    public void handleEditServiceAction() {
        if (validateInput()) {
            ...
            if(!category.equals(currentCategory)) {
                TransferObject response = FrontController.handleRequest(UPDATE, ACCESSORY_CATEGORY, category);
